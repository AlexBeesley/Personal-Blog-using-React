      ...
      <div className={Styles.row}>
        <div className={Styles.col1}>
          <Card
            ...
            paragraph2="React was chosen as it is a popular framework for building web applications, developed by Facebook, 
            ...
            paragraph3="Typescript is a superset of JavaScript and is used to write more robust, maintainable code. As it allows 
        ...
        <div className={Styles.col2}>
          <Card
            title="About me"
            paragraph1="I am a 21-year-old .NET Developer Intern for The Pensions Regulator. I am a self-taught programmer, 
            ...
            paragraph2="Fast-forward to 2016, I had taught myself basic Python and had touched on HTML, CSS and basic web 
            ...
            paragraph3="Before returning for my finally year, I choose to do a year placement with The Pensions Regulator, as a 
